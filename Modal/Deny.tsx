...
import Svg, { Path, Defs, LinearGradient, Stop } from "react-native-svg"; // Import SVG components
...
const Approve: React.FC<ApproveProps> = ({ visible, onClose }) => {
  return (
    <Modal
      animationType="slide"
      transparent={true}
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          {/* Add the SVG component below the logo */}
          ...
          <Text style={styles.modalText}>The code is Invalid.</Text>
          <Button title="VERIFY ANOTHER QR CODE" onPress={onClose} />
        </View>
      </View>
    </Modal>
  );
...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    width: "70%", // Use full width to control the image size
    height: undefined, // Allows the height to adjust based on aspect ratio
    aspectRatio: 1.5, // Maintain a 1:1 aspect ratio; adjust as necessary
    justifyContent: "center", // Center the logo vertically
    alignItems: "center", // Center the logo horizontally
    marginBottom: 0, // Space between the logo and the text
  },
  logo: {
